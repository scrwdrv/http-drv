...
function update(path) {
    return new Promise((resolve, reject) => fs.readFile(path, 'utf8', (err, data) => {
        ...
        resolve({
            dynamic: new Function('data', r.dynamic.string + 'return r;' + r.dynamic.functions + staticFunctions),
            static: new Function('data', 'return ' + r.static.html + ';' + r.static.functions + staticFunctions)
        });
